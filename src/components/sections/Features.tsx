    ...
    he: [
      {
        ...
        description: "יש מצב שחברת AI מובילה תעניק לי הכשרה מלאה??",
      ...
      {
        title: "להפוך למפתח AI אמיתי בתוך פחות שמונה חודשים",
        description: "הכשרה מקיפה וממוקדת תעשייה שבה נרכוש את כל הידע הנדרש להפוך למפתח AI מן השורה הראשונה",
